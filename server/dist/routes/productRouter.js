...
router.post('/', authMiddleware_1.ensureAuthenticated, authMiddleware_1.verifyAdmin, productControllers_1.addProduct);
...
router.get('/search', authMiddleware_1.ensureAuthenticated, authMiddleware_1.verifyAdmin, productControllers_1.searchProducts);
router.get('/:id', productControllers_1.getProductById);
router.post('/uppdate', authMiddleware_1.ensureAuthenticated, authMiddleware_1.verifyAdmin, productControllers_1.toggleInStock);
